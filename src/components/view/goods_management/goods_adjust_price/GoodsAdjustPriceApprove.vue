  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="creationDate" label="单据日期" width="110" show-overflow-tooltip/>
        ...
        <el-table-column prop="expiryDate" label="过期日期" width="100" show-overflow-tooltip/>
        <el-table-column prop="creatorClinicName" label="机构名称" min-width="300" show-overflow-tooltip/>
      </el-table>
      <el-pagination
    ...
    <!-- 调价单明细 -->
    <GoodsAdjustPriceApproveDetail :visible="dialog.visible" :row="dataGrid.row"
                                   :dialog-close="dialogClose" :data-grid-load-data="dataGridLoadData"/>
  </div>
</template>

<script>
import GoodsAdjustPriceApproveDetail from './GoodsAdjustPriceApproveDetail'
export default {
  components: {
    GoodsAdjustPriceApproveDetail
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/goodsAdjustPrice/getGroupListByCriteria'
