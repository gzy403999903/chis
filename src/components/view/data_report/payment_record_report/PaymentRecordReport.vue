  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="xj1" label="小计1" width="100" show-overflow-tooltip/>
        <el-table-column prop="xj2" label="小计2" width="100" show-overflow-tooltip/>
        <el-table-column prop="xj3" label="小计3" width="100" show-overflow-tooltip/>
