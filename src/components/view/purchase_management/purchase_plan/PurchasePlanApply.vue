  ...
  <div>
    ...
    <el-card
      ...
      <el-form :model="queryForm" ref="queryForm" :inline="true" size="mini">
        ...
        <el-form-item>
          ...
          <el-button type="default" round icon="el-icon-plus" @click="dialogOpen">添加计划</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="creationDate" label="计划日期" width="100" show-overflow-tooltip sortable/>
        <el-table-column prop="lsh" label="流水号" width="220" show-overflow-tooltip sortable/>
    ...
    <!-- 添加采购计划 -->
    <PurchasePlanApplyEdit :visible="dialog.visible"
...
<script>
import PurchasePlanApplyEdit from './PurchasePlanApplyEdit'

export default {
  components: {
    PurchasePlanApplyEdit
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/purchasePlan/getClinicListByCriteria'
