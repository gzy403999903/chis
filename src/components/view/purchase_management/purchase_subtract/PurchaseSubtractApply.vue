<template>
  <div>
    ...
    <el-card
      ...
      <el-button type="default" size="mini" round icon="el-icon-plus" @click="dialogOpen">新建退货单</el-button>
    </el-card>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="quantity" label="退货数量" width="80" show-overflow-tooltip/>
        <el-table-column prop="costPrice" label="退货单价" width="80" show-overflow-tooltip/>
    ...
    <!-- 编辑采购退货单 -->
    <PurchaseSubtractApplyEdit :visible="dialog.visible"
...
<script>
import PurchaseSubtractApplyEdit from './PurchaseSubtractApplyEdit'
export default {
  components: {
    PurchaseSubtractApplyEdit
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      const url = '/chisAPI/inventorySubtract/getClinicListByCriteria'
