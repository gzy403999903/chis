  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="creationDate" label="订单日期" width="160" show-overflow-tooltip/>
        ...
        <el-table-column prop="totalCostPrice" label="入库总额" width="110" show-overflow-tooltip sortable/>
        <el-table-column prop="creatorName" label="操作人" width="110" show-overflow-tooltip sortable/>
        <el-table-column prop="approverName" label="审核人" width="110" show-overflow-tooltip sortable/>
        <el-table-column prop="approveDate" label="审核日期" width="160" show-overflow-tooltip sortable/>
    ...
    <!-- 编辑入库明细 -->
    <PurchaseAddApproveDetail :visible="dialog.visible" :row="dataGrid.row"
...
<script>
import PurchaseAddApproveDetail from './PurchaseAddApproveDetail'

export default {
  components: {
    PurchaseAddApproveDetail
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      const url = '/chisAPI/inventoryAdd/getClinicLshGroupListByCriteria'
