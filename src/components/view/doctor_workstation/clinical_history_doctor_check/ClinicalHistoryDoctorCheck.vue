<template>
  <div>
    ...
    <el-card
      ...
      <el-form :model="queryForm" ref="queryForm" inline size="mini">
        ...
        <el-form-item label="会员姓名" prop="mrmMemberName">
          <el-input v-model.trim="queryForm.mrmMemberName" placeholder="会员姓名 / 助记码" style="width: 150px;"/>
        </el-form-item>
        <el-form-item label="会员电话" prop="phone">
          <el-input v-model.trim="queryForm.phone" placeholder="手机号码" style="width: 150px;"/>
        </el-form-item>
        <el-form-item>
    ...
    <!-- 病例详情 -->
    <ClinicalHistoryDoctorDetail :visible="dialog.visible" :row="dataGrid.row" :dialogClose="dialogClose"/>
  </div>
</template>

<script>
import ClinicalHistoryDoctorDetail from './ClinicalHistoryDoctorDetail'
export default {
  components: {
    ClinicalHistoryDoctorDetail
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/clinicalHistory/getByCriteriaForDoctorCheck'
