  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="expendBalance" label="扣减余额" width="80" show-overflow-tooltip/>
        <el-table-column prop="balance" label="剩余余额" width="80" show-overflow-tooltip/>
...
export default {
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/expendRecord/getByCriteria'
