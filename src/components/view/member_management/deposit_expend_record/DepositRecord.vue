  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <!--<el-table-column label="是否可退" width="100" show-overflow-tooltip>
          <template slot-scope="props">
            <span v-show="props.row.returned">是</span>
            <span v-show="!props.row.returned" style="color: red;" >否</span>
          </template>
        </el-table-column>-->
...
export default {
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/depositRecord/getByCriteria'
