  ...
  <div>
    ...
    <el-card
      ...
      <el-form :model="queryForm" ref="queryForm" inline size="mini">
        ...
        <el-form-item label="会员姓名" prop="mrmMemberName">
          <el-input v-model.trim="queryForm.mrmMemberName" placeholder="会员姓名 / 助记码 / 手机" style="width: 150px;"/>
        </el-form-item>
        <el-form-item>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="exchangePoints" label="扣减积分" width="80" show-overflow-tooltip/>
        <el-table-column prop="givenPoints" label="赠送积分" width="80" show-overflow-tooltip/>
        <el-table-column prop="points" label="剩余积分" width="80" show-overflow-tooltip/>
...
export default {
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/pointsRecord/getByCriteria'
