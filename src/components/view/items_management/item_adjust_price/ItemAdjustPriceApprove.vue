<template>
  <div>
    ...
    <!-- 调价单明细 -->
    <ItemAdjustPriceApproveDetail :visible="dialog.visible" :row="dataGrid.row"
                                  :dialog-close="dialogClose" :data-grid-load-data="dataGridLoadData"/>
  </div>
</template>

<script>
import ItemAdjustPriceApproveDetail from './ItemAdjustPriceApproveDetail'
export default {
  components: {
    ItemAdjustPriceApproveDetail
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/itemAdjustPrice/getGroupListByCriteria'
