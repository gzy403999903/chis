  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="cimItemName" label="挂号类型" width="120" show-overflow-tooltip/>
        <el-table-column prop="sysDoctorName" label="医生姓名" width="100" show-overflow-tooltip/>
...
export default {
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/registrationRecord/getClinicListByCriteria'
