  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="sysClinicName" label="机构名称" min-width="300" show-overflow-tooltip/>
      </el-table>
      <el-pagination
    ...
    <!-- 新建领用申请单 -->
    <SelfUsedApproveDetail :visible="dialog.visible" :row="dataGrid.row"
                       :dialogClose="dialogClose" :dataGridLoadData="dataGridLoadData"/>
  </div>
</template>

<script>
import SelfUsedApproveDetail from './SelfUsedApproveDetail'
export default {
  components: {
    SelfUsedApproveDetail
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/selfUsedRecord/getClinicGroupListByCriteria'
