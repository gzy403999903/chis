<template>
  <div>
    ...
    <el-card
      ...
      <el-form :model="queryForm" ref="queryForm" inline size="mini">
        ...
        <el-form-item>
          ...
          <el-button type="default" round icon="el-icon-plus" @click="dialogOpen">领用申请单</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    ...
    <!-- 新建领用申请单 -->
    <SelfUsedApplyEdit :visible="dialog.visible"
                       :dialogClose="dialogClose" :dataGridLoadData="dataGridLoadData"/>
  </div>
</template>

<script>
import SelfUsedApplyEdit from './SelfUsedApplyEdit'
export default {
  components: {
    SelfUsedApplyEdit
  },
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      let url = '/chisAPI/selfUsedRecord/getClinicListByCriteria'
