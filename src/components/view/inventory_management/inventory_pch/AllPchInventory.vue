  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <!--<el-table-column prop="retailPrice" label="零售价" width="100" show-overflow-tooltip sortable/>-->
        ...
        <el-table-column prop="quantity" label="库存数量" width="120" show-overflow-tooltip sortable/>
        ...
        <el-table-column prop="costPrice" label="批次进价" width="120" show-overflow-tooltip sortable/>
        <el-table-column prop="firstCostPrice" label="一成本价" width="120" show-overflow-tooltip sortable/>
        <el-table-column prop="expiryDate" label="有效期至" width="120" show-overflow-tooltip sortable/>
...
export default {
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      const url = '/chisAPI/inventory/getPchListByCriteria'
