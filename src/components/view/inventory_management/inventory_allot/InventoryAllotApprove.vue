  ...
  <div>
    ...
    <el-card
      ...
      <el-table
        ...
        <el-table-column prop="originalIymInventoryTypeName" label="调出仓库" width="100" show-overflow-tooltip/>
        <el-table-column prop="toIymInventoryTypeName" label="调入仓库" width="100" show-overflow-tooltip/>
        ...
        <el-table-column prop="approveState" label="审批状态" min-width="100" :formatter="dataGridFormatterApproveSate" show-overflow-tooltip sortable/>
      </el-table>
      <el-pagination
    ...
    <!-- 编辑入库明细 -->
    <InventoryAllotDetail :visible="dialog.visible" :row="dataGrid.row"
                                :dialogClose="dialogClose" :dataGridLoadData="dataGridLoadData"/>
  </div>
</template>

<script>
import InventoryAllotDetail from './InventoryAllotDetail'
...
export default {
  ...
  methods: {
    ...
    dataGridLoadData () {
      this.$loading()
      const url = '/chisAPI/inventoryAllot/getClinicLshGroupListByCriteria'
